...
def allumette(joueur1: str, joueur2: str):
    ...
    print("|" * allumette)
    while allumette > 0:  # Tour du joueur 1
...
=======
>>>>>>> 2a72cd9e02e918cba849ed00546942c965c0fba1
        print(f"{joueur1} a pris {choixj1} allumettes.")
        print("Il reste", allumette, "allumettes.")
        print("|" * allumette)         # Tour du joueur 2
...
=======
        ...
        if allumette <= 0:
            perdant = 2
            cond_vic(perdant, joueur1, joueur2)   # Affichage des résultats
>>>>>>> 2a72cd9e02e918cba849ed00546942c965c0fba1
